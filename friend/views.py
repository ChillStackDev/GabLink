...
def friends_list_view(request, *args, **kwargs):
    # sourcery skip: de-morgan, for-append-to-extend, list-comprehension, merge-nested-ifs, move-assign-in-block, remove-unnecessary-else, swap-if-else-branches, use-named-expression
    context = {}
    user = request.user
...
def send_friend_request(request, *args, **kwargs):
    # sourcery skip: none-compare, use-named-expression
    user = request.user
    payload = {}
